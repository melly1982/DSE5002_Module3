...
if(people_in_line >2  & scones_in_stock == FALSE)
{
  cat("I will NOT stop at Starbucks\n")
}else
{if(people_in_line == 0|1|2 & scones_in_stock == TRUE)
  {
    cat("I will stop at Starbucks")
  }
  else
  {if (people_in_line == 3|4 & scones_in_stock == TRUE)
  {
    cat("I will stop at Starbucks\n")
  }
    else
    {if(people_in_line >4 & scones_in_stock == TRUE || FALSE)
    cat("I will not stop at Starbucks\n")
      }
  }
  }
